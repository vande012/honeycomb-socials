              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    'hover:before:bg-neutral-200 hover:before:opacity-100 hover:before:duration-0 hover:after:bg-neutral-100 hover:after:opacity-100 hover:after:duration-0',
