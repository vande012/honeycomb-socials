...
export const metadata = {
  ...
  description: 'Social media management, content creation, and strategy for beauty businesses. Custom packages that grow your following and convert clients. Get started today.',
